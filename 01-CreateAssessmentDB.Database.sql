/****** Object:  Database [AssessmentDB]    Script Date: 4/28/2026 1:48:18 AM ******/
IF DB_ID('AssessmentDB') IS NOT NULL
BEGIN
    ALTER DATABASE AssessmentDB SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
